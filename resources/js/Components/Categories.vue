        ...
        <div class="container">
            ...
            <div v-for="category in categories" :key="category.id" class="category-block">
                <div class="category-header">
                    <h2 class="category-title">{{ category.name_bn }}</h2>
                    <a :href="`/category/${category.slug}`" class="view-all">আরো দেখুন →</a>
                </div>
                <div class="products-grid">
                    <div v-for="product in category.products.slice(0, 5)" :key="product.id" class="product-card">
                        <div class="card-top">
