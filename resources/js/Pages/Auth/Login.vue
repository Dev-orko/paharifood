...
<template>
    <GuestLayout>
        <Head title="লগইন — পাহাড়ি স্বাদ" />

        <div class="login-page">
            <div class="login-header">
                <h1 class="login-title">আপনার অ্যাকাউন্টে প্রবেশ করুন</h1>
                <p class="login-subtitle">পাহাড়ি স্বাদে আবারও স্বাগতম! কেনাকাটা চালিয়ে যেতে লগইন করুন।</p>
            </div>
            ...
            <form @submit.prevent="submit" class="login-form">
                ...
                <div class="form-check">
                    <label class="check-label">
                        ...
                        <span class="check-text">আমাকে মনে রাখুন</span>
                    </label>
                </div>
            ...
            <div class="auth-footer">
                <p>এখনো অ্যাকাউন্ট নেই? <Link :href="route('register')" class="auth-footer-link">নতুন অ্যাকাউন্ট তৈরি করুন</Link></p>
            </div>
